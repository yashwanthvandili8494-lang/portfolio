...
const skillCategories = [
  { 
    ...
    desc: 'Maintaining application availability, SLI tracking, root cause analysis (RCA), and incident resolution across environments.', 
    tag: 'RELIABILITY',
    skills: ['Service Level Indicators (SLIs)', 'Application Availability', 'Incident Troubleshooting', 'Root Cause Analysis (RCA)', 'Uptime'] 
  },
  { 
    title: 'Cloud Platforms & Infra', 
    desc: 'Architecting hybrid cloud infrastructure across Microsoft Azure and AWS with strict IAM/RBAC governance.', 
    tag: 'CLOUD PLATFORMS',
    skills: ['Microsoft Azure (VMs, Blob, VNet)', 'AWS (EC2, S3, VPC)', 'Hybrid Cloud', 'IAM / RBAC Security'] 
  },
  { 
    title: 'CI/CD & Deployments', 
    desc: 'Automating multi-environment build and release management across Dev, Test, Staging, and Production.', 
    tag: 'CI/CD AUTOMATION',
    skills: ['GitHub Actions', 'Azure DevOps', 'Jenkins', 'Build & Release Management', 'Multi-Env Deployments'] 
  },
  { 
    title: 'Containers & Orchestration', 
    desc: 'Containerizing workloads and configuring managed Kubernetes pods for scalable microservice deployments.', 
    tag: 'CONTAINERS',
    skills: ['Docker Containers', 'Kubernetes Concepts', 'Azure Kubernetes Service (AKS)', 'Amazon EKS'] 
  },
  { 
    title: 'Monitoring & Scripting', 
    desc: 'Setting up metric alert triggers, log analysis, and automation scripting for proactive system diagnostics.', 
    tag: 'MONITORING & SCRIPTING',
    skills: ['Azure Monitor', 'AWS CloudWatch', 'Log Analysis & Alerts', 'Python', 'Bash', 'PowerShell'] 
  },
  { 
    title: 'Governance & SDLC', 
    desc: 'Driving Agile/Scrum ceremonies, clean SDLC practices, comprehensive runbook documentation, and resource optimization.', 
    tag: 'GOVERNANCE & SDLC',
    skills: ['Agile / Scrum', 'SDLC Best Practices', 'Runbook Documentation', 'Resource Optimization', 'Git / GitHub'] 
  },
];
