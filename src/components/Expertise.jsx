...
const expertiseData = [
  {
    number: "01",
    title: "Full Stack & AI / SRE Intern",
    subtitle: "Tamizhan Skills (May 2024 – Jul 2024)",
    text: "Developed full-stack web applications and microservices using Python, Java, Node.js, React.js, and Angular. Supported CI/CD execution in GitHub Actions, deployed Docker container workloads, and monitored logs across Dev, Test, and Staging.",
    tag: "INTERNSHIP // FULL STACK & SRE",
    gradient: "from-[#1f0a0c] via-[#121212] to-[#0a0a0a]"
  },
  {
    number: "02",
    title: "AI & Full-Stack Platform Engineering Intern",
    subtitle: "Future Interns (Nov 2024 – Apr 2025)",
    text: "Designed stateful backend services & multi-step agent pipelines in Python (FastAPI) and Node.js. Configured Docker containers, maintained GitHub Actions CI/CD, PostgreSQL/MySQL schemas, Redis caching, and automated metric alerts.",
    tag: "INTERNSHIP // AI PLATFORM ENG",
    gradient: "from-[#1a0809] via-[#111111] to-[#090909]"
  },
  {
    number: "03",
    title: "Auditor Intern",
    subtitle: "Compliance Unit (Jan 2023 – Mar 2023)",
    text: "Audited operational process workflows, system compliance data, and access control logs with analytical precision. Verified audit trails, data integrity, and compliance reporting across business operations.",
    tag: "INTERNSHIP // COMPLIANCE & AUDIT",
  ...
  },
  {
    ...
    text: "Engineered hybrid cloud deployments, tracked Service Level Indicators (SLIs), managed IAM/RBAC policies, handled log analysis/metric alerts in Azure Monitor & CloudWatch, and authored Python/Bash automation scripts.",
    tag: "SRE & CLOUD INFRASTRUCTURE",
      ...
      <div className="relative z-10 max-w-6xl mx-auto w-full space-y-12">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 pb-2">
          ...
          <p className="text-white/60 text-xs md:text-sm font-light leading-relaxed max-w-xs">
            Hands-on SRE, DevOps, cloud platform engineering, and full-stack software development experience.
          </p>
        </div>
